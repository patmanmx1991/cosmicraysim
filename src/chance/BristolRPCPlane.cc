...
// --------------------------------------------------------------------------
void BristolRPCPlane::Construct(DBTable table) {
  ...
  // Should be a plane of glass, then a layer of gas then a plane of glass and aluminium.
  // Use a union to piece together 3 planes into a single volume that we treat as sensitive.
  // Then add the other glass+aluminium planes on the top and bottom in a similar fashion.
  // Then can simply add the aluminium spacer between them later.
