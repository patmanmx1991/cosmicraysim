...
public:
  ...
  GeoObject* GetRPCTopY() { return fRPCTopX; };
...
protected:
  ...
  BristolRPCProcessor* fRPCProcTop; ///< Processor for the Bristol RPC Hits above
  BristolRPCProcessor* fRPCProcBottom; ///< Processor for the Bristol RPC hits below
